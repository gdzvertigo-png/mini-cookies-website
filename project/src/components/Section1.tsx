    ...
    <section className="py-24 sm:py-32 px-6 bg-jet-black">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center gap-4 mb-12">
          <span className="text-xs tracking-[0.3em] uppercase text-white/40 font-medium">1<br /></span>
        ...
        >
          <span style={{ fontSize: 'clamp(1.75rem, 8vw, 60px)', whiteSpace: 'nowrap' }}>Earn $3,000-$20,000+</span>
          <br />
          <span style={{ color: '#e5e7eb' }}>as a WebCam Model</span>
        </h2>
