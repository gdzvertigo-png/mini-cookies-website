    ...
    <section className="py-24 sm:py-40 px-6 bg-jet-black border-t border-white/5 relative overflow-hidden">
      ...
      <div className="max-w-3xl mx-auto text-center relative z-10">
        <div className="flex items-center justify-center gap-4 mb-12">
          ...
          <span className="text-xs tracking-[0.3em] uppercase text-white/40 font-medium">8</span>
          <div className="h-px w-12 bg-white/20" />
        </div>
        ...
        >
          <span style={{ fontStyle: 'italic', fontSize: '33px' }}>One Message Can Change Everything</span>
        </h2>
