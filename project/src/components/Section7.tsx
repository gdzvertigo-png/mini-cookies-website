    ...
    <section className="py-24 sm:py-32 px-6 bg-jet-black border-t border-white/5">
      <div className="max-w-5xl mx-auto">
        <div className="flex items-center gap-4 mb-12">
          <span className="text-xs tracking-[0.3em] uppercase text-white/40 font-medium">7</span>
        ...
        >
          <span style={{ fontStyle: 'italic' }}>12 Months From Now</span><br /><span style={{ fontStyle: 'italic' }}>&nbsp;One Of Two Things Is 100% True</span>
        </h2>
