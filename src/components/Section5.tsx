    ...
    <section className="py-24 sm:py-32 px-6 bg-jet-black border-t border-white/5">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center gap-4 mb-12">
          <span className="text-xs tracking-[0.3em] uppercase text-white/40 font-medium">05</span>
        ...
        >
          You{"\u2019"}ve probably heard about OnlyFans.
          <br />
          <span className="text-white/60">The GAME has completely changed.</span>
          <br />
          <span className="text-white/40">It{"\u2019"}s not as EASY as it used to be a few years ago.</span>
        </h2>
