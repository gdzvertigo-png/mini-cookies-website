    ...
    <section className="py-24 sm:py-32 px-6 bg-jet-black border-t border-white/5 overflow-hidden">
      <div className="max-w-6xl mx-auto">
        <div className="flex items-center gap-4 mb-12">
          <span className="text-xs tracking-[0.3em] uppercase text-white/40 font-medium">03</span>
          <div className="h-px flex-1 bg-white/10" />
        </div>

        <h2
          className="font-extrabold tracking-tight leading-[1.1] mb-16 max-w-4xl"
          style={{ fontSize: 'clamp(1.75rem, 5vw, 3.5rem)' }}
        >
          Other mini cookies that never thought WebCam is for them
        </h2>
